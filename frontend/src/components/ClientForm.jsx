...
//   return (
//     <div className="flex items-center mt-18 justify-center min-h-screen bg-[rgb(9,8,7)] p-4">
//       <div className="w-full max-w-5xl h-[85vh] flex flex-col lg:flex-row items-center justify-between bg-black/40 backdrop-blur-md shadow-2xl rounded-3xl overflow-hidden border border-gray-700">
        
//         {/* Left - Form Section */}
//         <div className="w-full lg:w-1/2 h-full p-8 text-white bg-[rgb(24,30,35)] flex flex-col justify-between">
//           <div>
//             <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-6 bg-[#ffb300] bg-clip-text text-[#ffb300]">
//               Plan Your Event
//             </h2>
...
//         {/* Right - Image Section */}
//         <div className="w-full lg:w-1/2 h-full bg-cover bg-center p-4 bg-gray-800/90" style={{ backgroundImage: `url(/eve23.jpg)` }}>
//           <div className="flex justify-center gap-6 pt-4">
//             <span
//               className="text-cyan-300 text-lg font-semibold cursor-pointer hover:underline hover:text-cyan-100 transition-colors"
//               onClick={() => navigate("/clientform")}
...
const ClientForm = () => {
  ...
  return (
    <div className="flex items-center mt-18 justify-center min-h-screen bg-[rgb(9,8,7)] p-4 overflow-x-hidden">
      <div className="w-full max-w-5xl h-auto lg:h-[85vh] flex flex-col lg:flex-row items-center justify-between bg-black/40 backdrop-blur-md shadow-2xl rounded-3xl overflow-hidden border border-gray-700">
        
        {/* Left - Form Section */}
        <div className="w-full lg:w-1/2 h-full p-8 text-white bg-[rgb(24,30,35)] flex flex-col justify-between overflow-auto">
          <div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-6 bg-[#ffb300] bg-clip-text text-[#ffb300]">
              Plan Your Event
            </h2>
