...
const About = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0412] text-white p-6">
      <div className="bg-[rgb(17,17,17)] text-gray-100 p-8 rounded-3xl shadow-2xl max-w-3xl text-center border border-gray-900">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400">
          About EveMan
        </h1>
        ...
        <div className="mt-6">
          <button className="bg-indigo-500 hover:bg-indigo-600 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-indigo-600/50 transition-all duration-300">
            Learn More
          </button>
        </div>
      </div>
