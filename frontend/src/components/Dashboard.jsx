...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[rgb(9,8,7)] p-4 md:p-8">
      <div className="bg-[rgb(24,30,35)] backdrop-blur-md p-6 shadow-xl rounded-3xl w-full max-w-6xl h-[70vh] text-center border border-gray-700">
        <h2 className="text-3xl md:text-4xl font-bold text-[#ffb300] mb-6 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text">
          Welcome to Your Dashboard
        </h2>
        <p className="text-xs sm:text-sm text-gray-400 mb-8">Manage and track your events seamlessly.</p>
        ...
        <div className="flex justify-center gap-4 sm:gap-6 mt-6 flex-wrap">
          <button
            onClick={handleLogout}
            className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg text-lg sm:text-xl font-semibold shadow-md hover:from-blue-700 hover:to-purple-700 hover:scale-105 transition"
          >
            Logout
          </button>
