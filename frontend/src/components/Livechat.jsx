...
//       <div className="w-96 p-5 text-white bg-[rgb(6,6,7)] backdrop-blur-lg shadow-xl rounded-2xl border border-black">
//         <h2 className="text-xl font-bold text-white text-center mb-3">
//           💬 Live Chat
//         </h2>
//         <div className="  hover:shadow-3xl border-amber-100 h-64 overflow-y-auto hover: bg-gray-800 p-3 rounded-lg shadow-inner space-y-2">
