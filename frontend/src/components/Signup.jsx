    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-900 p-6">
      <div className="w-full md:w-3/4 lg:w-1/2 flex flex-col md:flex-row items-center justify-between bg-gray-800 shadow-2xl rounded-3xl overflow-hidden border border-gray-700">
        ...
        <div className="w-full md:w-1/2 p-10 text-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                type="text"
                className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                value={name}
                onChange={(e) => setName(e.target.value)}
                required
                placeholder="Enter your name"
            ...
            <button
              type="submit"
              className="w-full text-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-md"
            >
              Sign Up
            </button>
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-white text-gray-800 py-2 rounded-lg hover:bg-gray-100 transition-all duration-300"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-black text-white py-2 rounded-lg hover:bg-gray-900 transition-all duration-300"
              >
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center relative group">
          <img
            className="w-full h-[300px] sm:h-[500px] object-cover rounded-3xl cursor-pointer transition-transform duration-300 group-hover:scale-105"
            src="/eveman6.jpg"
            alt="Event"
            onClick={() => navigate("/about")}
          />
