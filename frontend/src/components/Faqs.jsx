...
//       <div className=" p-8 rounded-2xl shadow-lg bg-[rgb(6,6,7)] w-full max-w-2xl">
//         <h1 className="text-3xl font-bold text-center mb-6 text-gray-400">Frequently Asked Questions</h1>
