...
const EvemanInsights = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center text-center py-16 px-10">
      <div className="w-full max-w-8xl bg-[rgb(27,35,41)] shadow-mg border-2 border-black rounded-2xl p-15">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
          ...
          <p className="text-1xl text-gray-100 font-semibold">
          ...
          <p className="text-1xl text-gray-200 font-semibold md:col-span-2">
            <span className="text-[#9e3c51]">{insights.positiveFeedback}</span> Positive Feedback
          </p>
        </div>
        <p className="mt-4 text-sm text-gray-400 font-semibold"> Response Time: 25 minutes</p>
      </div>
    </div>
  );
};
