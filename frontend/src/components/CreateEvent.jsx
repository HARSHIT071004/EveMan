...
const CreateEvent = () => {
  ...
  return (
    <div className="flex items-center mt-18 justify-center min-h-screen p-4">
      <div className="w-full max-w-5xl h-auto md:h-[85vh] flex flex-col md:flex-row items-center justify-between bg-black/40 backdrop-blur-md shadow-2xl rounded-3xl overflow-hidden border border-gray-700">
        
        {/* Left - Form Section */}
        <div className="w-full md:w-1/2 h-full p-6 sm:p-8 text-white bg-[rgb(24,30,35)] flex flex-col justify-between">
          <div>
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-6 bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-[#ffb300]">
              Create Event
            </h2>
            {error && (
              <p className="text-red-400 text-center bg-red-900/20 p-2 rounded-lg text-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-sm sm:text-base font-medium text-gray-300">Description</label>
                <textarea
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300 placeholder-gray-500"
                  value={description}
                  onChange={(e) => setDescription(e.target.value)}
              ...
              <button
                type="submit"
                className="w-full text-base sm:text-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                disabled={loading}
              >
                {loading ? "Creating..." : "Create Event"}
              </button>
        ...
        {/* Right - Image Section */}
        <div className="w-full md:w-1/2 h-64 md:h-full bg-cover bg-center p-4 bg-gray-800/90" style={{ backgroundImage: `url(/eve23.jpg)` }}>
        </div>
      </div>
    </div>
  );
